...
public final class AuctionHouseModule implements SsuModule {
    ...
    @Override public boolean isEnabled() { return Config.ENABLE_AUCTION_HOUSE.get() && Config.ENABLE_MAIL.get(); }
    @Override public Set<String> dependencies() { return Set.of("storage", "transactions", "economy", "mail", "permissions"); }
