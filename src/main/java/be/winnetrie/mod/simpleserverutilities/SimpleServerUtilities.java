...
import be.winnetrie.mod.simpleserverutilities.achievement.AchievementEvents;
import be.winnetrie.mod.simpleserverutilities.achievement.AchievementManager;
import be.winnetrie.mod.simpleserverutilities.achievement.AchievementModule;
...
import be.winnetrie.mod.simpleserverutilities.content.ContentGameplayEvents;
import be.winnetrie.mod.simpleserverutilities.content.ContentRewardLedger;
...
public class SimpleServerUtilities {
    ...
    public static final ContentRewardLedger CONTENT_REWARD_LEDGER = new ContentRewardLedger();
    public static final TemporaryPermissionManager TEMPORARY_PERMISSIONS = new TemporaryPermissionManager();
    public static final ContentActionEngine CONTENT_ACTIONS = new ContentActionEngine(CONTENT_PROGRESS, TRANSACTIONS, CONTENT_REWARD_LEDGER);
    ...
    public SimpleServerUtilities(IEventBus modEventBus, ModContainer modContainer) {
        ...
        NeoForge.EVENT_BUS.register(ContentGameplayEvents.class);
        ...
        NeoForge.EVENT_BUS.register(be.winnetrie.mod.simpleserverutilities.identity.EntityInsightEvents.class);
